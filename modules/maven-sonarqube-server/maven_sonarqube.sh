...
server {
    listen 80;
    server_name sonarqube.alakadtechworld.com;
...
sudo certbot --nginx -d sonarqube.alakadtechworld.com --email rahmon.jay1@gmail.com --non-interactive --agree-tos --redirect
...
echo "sonarqube is now accessible via https://sonarqube.alakadtechworld.com"
