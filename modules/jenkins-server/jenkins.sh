...
server {
    listen 80;
    server_name jenkins.alakadtechworld.com;
...
sudo certbot --nginx -d jenkins.alakadtechworld.com --email rahmon.jay1@gmail.com --non-interactive --agree-tos --redirect
...
echo "Jenkins is now accessible via https://jenkins.alakadtechworld.com"
